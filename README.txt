...
With Bulk Media Upload you can upload a bunch of media files and a new node
will be created for every file. Default values can be chosen for the other
fields assigned to the new node.
